export const translations = {
  "zh": {
    ...
    "translator.mode.text": "文本",
    "translator.mode.voice": "语音",
    "translator.voice.tapToTalk": "点击开始录音",
    "translator.voice.listening": "正在聆听...",
    "translator.voice.error": "录音失败",
    "translator.voice.notAllowed": "麦克风或语音识别权限已被拒绝，请在系统设置中允许使用麦克风与语音识别",
    "translator.voice.serviceNotAllowed": "系统语音识别服务不可用（请在 macOS「系统设置 -> 键盘 -> 听写」中开启听写）",
    "translator.voice.networkError": "语音识别服务连接失败（需网络连接）",
    "translator.voice.audioCapture": "未检测到麦克风或麦克风被占用",
    "translator.voice.notsupported": "当前环境暂不支持内置连续语音听写",
    "translator.clear.btn": "清空",
    "translator.clear.text": "清空输入文本",
    "translator.clear.voice": "清空语音听写记录",
    "translator.voice.clear": "清除记录",
    "translator.voice.clearConfirm": "确定要清除所有语音翻译记录吗？",
    "translator.voice.deleteItem": "删除此条记录",
    ...
    "reader.interference": "通联环境干扰 (QRN/QRM)",
    "reader.interference.short": "通联干扰",
    "reader.interference.desc": "模拟真实短波无线电天电底噪、雷电劈啪与邻频干扰",
    "reader.interference.clean": "无干扰 (纯净)",
    "reader.interference.light": "轻度 (S5)",
    "reader.interference.medium": "中度 (S7)",
    "reader.interference.heavy": "恶劣 (S9+)",
    "reader.interference.mode.noise": "底噪 (QRN)",
    "reader.interference.mode.noiseDesc": "电离层窄带背景噪声与雷电瞬态",
    "reader.interference.mode.qsb": "衰落 (QSB)",
    "reader.interference.mode.qsbDesc": "信号周期性忽大忽小自然衰落",
    "reader.interference.mode.qrh": "频漂 (QRH)",
    "reader.interference.mode.qrhDesc": "老式发报机真空管温漂与变调",
    "reader.interference.mode.qrm": "邻台 (QRM)",
    "reader.interference.mode.qrmDesc": "邻近频点其他电台的弱呼叫干扰",
    ...
    "reader.font.cascadia": "Cascadia Mono",
    "reader.font.sfmono": "SF Mono",
    "reader.font.jetbrains": "JetBrains Mono",
    "reader.font.fira": "Fira Code",
    "reader.font.dejavu": "DejaVu Sans Mono",
    ...
    "reader.tooltip.fontSizeDec": "减小字号 (-1)",
    "reader.tooltip.fontSizeInc": "增大字号 (+1)",
  ...
  "en": {
    ...
    "sidebar.game": "Morse Waterfall",
    "sidebar.expand": "Expand",
    "sidebar.collapse": "Collapse",
    "translator.editor.title": "Smart Translator",
    ...
    "translator.mode.text": "Text",
    "translator.mode.voice": "Voice",
    "translator.voice.tapToTalk": "Tap to talk",
    "translator.voice.listening": "Listening...",
    "translator.voice.error": "Recognition Error",
    "translator.voice.notAllowed": "Microphone or Speech Recognition permission denied. Please allow it in System Settings.",
    "translator.voice.serviceNotAllowed": "Speech recognition service unavailable (Please enable Dictation in macOS System Settings > Keyboard)",
    ...
    "translator.voice.notsupported": "Continuous speech recognition not supported in this environment",
    "translator.clear.btn": "Clear",
    "translator.clear.text": "Clear input text",
    "translator.clear.voice": "Clear voice history",
    "translator.voice.clear": "Clear History",
    "translator.voice.clearConfirm": "Are you sure you want to clear all voice translation records?",
    "translator.voice.deleteItem": "Delete this record",
    ...
    "reader.interference": "Radio Interference (QRN/QRM)",
    "reader.interference.short": "Interference",
    "reader.interference.desc": "Simulate real HF atmospheric noise, static crashes, and QRM",
    "reader.interference.clean": "None (Clean)",
    "reader.interference.light": "Light (S5)",
    "reader.interference.medium": "Medium (S7)",
    "reader.interference.heavy": "Severe (S9+)",
    "reader.interference.mode.noise": "Noise (QRN)",
    "reader.interference.mode.noiseDesc": "Atmospheric passband noise and static",
    "reader.interference.mode.qsb": "Fading (QSB)",
    "reader.interference.mode.qsbDesc": "Periodic signal amplitude fading",
    "reader.interference.mode.qrh": "Drift (QRH)",
    "reader.interference.mode.qrhDesc": "VFO temperature drift and wobble",
    "reader.interference.mode.qrm": "Station (QRM)",
    "reader.interference.mode.qrmDesc": "Interference from adjacent CW stations",
    ...
    "update.download.apk": "Download APK",
    ...
    "reader.tooltip.fontSizeDec": "Decrease Font Size (-1)",
    "reader.tooltip.fontSizeInc": "Increase Font Size (+1)",
